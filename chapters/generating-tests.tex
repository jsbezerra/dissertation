...
\newadd{Once having the doubly-typed graph rules, we proceed to the creation of the causal relation, which is the first indicative of whether it is possible to construct an occurrence graph grammar for this collection of rules. Remember that this relation must be a total order, otherwise it indicates a problem in the modelling or in the system.}
