...
\begin{description}
  ...
  \item[Serve table:] A waiter goes to an occupied table to take an order, which consists of adding or removing items to the order, then closing it and sending it to the kitchen to be prepared.
