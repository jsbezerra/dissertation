\chapter{Conclusions}\label{ch:conclusions}
  ...
  We proposed an extension to the framework of occurrence graph grammars, previously defined by~\cite{Ribeiro1996} and~\cite{Corradini1996},  to deal with negative application conditions. The calculation of occurrence graph grammars from graph grammars was implemented on Verigraph, which now supports doubly-typed graph grammars in general.
