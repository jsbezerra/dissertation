...
\textbf{Basic categorial operations:} and type classes (e.g. \code{Complete}, \code{equalizer, product, pullback, limits}.
...
\textbf{NACs in strongly safe grammars:}

\textbf{Different graph rewriting approaches:}
