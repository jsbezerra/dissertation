...
\begin{definition}[Causal Dependency] \tinytodo{explain and put the other morphisms in the diagram}

\diagram{
    N_1 & & & & N_2 & & \\
      L_1\ar[d]\ar[u]^{n_1} & K_1\ar[d]\ar[l]\ar[r] & R_1\ar[dr]^{e_1} & & L_2\ar[dl]_{e_2}\ar[u]^{n_2} & K_2\ar[d]\ar[l]\ar[r] & R_2\ar[d]\\
