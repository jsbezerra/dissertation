...
\begin{example}[Graph Rule Example and Notation] Figure~\ref{fig:gts:rule_format} shows an example of a graph rule which reads a node of the type $\Circle$, deletes a node of the type $\triangle$ and then creates a node of the type $\Square$ with an edge between them.
...
\begin{example}[Graph Transformation Examples] Figure~\ref{fig:gts:transformation} shows a transformation where the rule depicted in Figure~\ref{fig:gts:rule_format} is successfully applied over a graph instance $G_0$.
...
\begin{figure}[!ht]
  \centering
  \fbox{\includegraphics[scale=0.5]{images/gts/transformation}}
  \caption{Graph transformation}\label{fig:gts:transformation}
\end{figure}

\begin{figure}[!ht]
  \centering
  \fbox{\includegraphics[scale=0.5]{images/gts/transformation-failed}}
...
\begin{figure}[!ht]
  \centering
  \subfloat[A satisfied NAC]{\label{fig:gts:nacs:satisfied}\fbox{\includegraphics[scale=0.55]{images/gts/satisfied_nac}}}
  \subfloat[A triggered NAC]{\label{fig:gts:nacs:triggered}\fbox{\includegraphics[scale=0.55]{images/gts/triggered_nac}}}
