...
\begin{itemize}
  ...
  \item morphisms explanation and classification (mono, epi, iso)
  \item category examples in set and maybe in graphs
\end{itemize}
...
Here we present the basic categorial constructions that are used in this work, this is not an extensive list, as we present only the ones necessary to our scope. For a more in-depth explanation of Categories and their applications in Computer Science see~\cite{Pierce1991}.
