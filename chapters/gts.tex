...
\begin{example}[Category of Sets] \cat{Set} is the category whose objects are \emph{sets} and the arrows and the arrows are \emph{total functions} between sets.

  The proof follows form the fact that: \tinytodo{review proof} 
...
\begin{example}[Monomorphism, Epimorphism and Isomorphism Examples]
  ...
  In \cat{Graph}\ldots \tinytodo{put examples}
