...
\begin{example}[Colimits in \cat{Set}] In general, colimits generalize constructions such as disjoint unions, direct sums, coproducts and others, where different objects of a diagram are ``glued'' together in only one object respecting existent identifications, if any.
