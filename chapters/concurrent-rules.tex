...
\begin{definition}[Left NACs from Right NACs] To transfer a NAC over a rule or even over a span we can use de DPO rewritting, as in:\tinytodo{write the fundamentals of it}
