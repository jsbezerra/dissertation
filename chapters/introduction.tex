...
\important{The main contributions of this thesis are (1) the development of a strategy for the generation of test cases for graph grammars, which required (2) an extension of the theory of Occurrence Graph Grammar frameworks to allow the tests generation for complex, realistic systems modelled as graph grammars and (3) the implementation of this strategy in the Verigraph System.}
