...
The problem with conditional relations in the core graph\tinytodo{expand}\tinytodo{We will probably need to start using incremental negative application conditions only~\cite{Corradini2013}}
