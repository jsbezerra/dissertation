...
In ispite of it, the implementation of the compiling algorithm is out of the scope of this thesis and it is left as future work.
...
\begin{definition}[Core Graph] Given a doubly-typed graph grammar \doublyTypedGraphGrammarCore{}, we have that \coreGraph{} is a \emph{core graph} iff the two following conditions hold\tinytodo{check whether this definition is correct/complete}
:
...
\begin{figure}[!ht]
  ...
  \caption{False positives captured by the classical notions of dependency and conflict}\label{fig:process:order:occurrence-relation-fail}
\end{figure}
