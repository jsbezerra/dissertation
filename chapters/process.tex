...
Occurrence graph grammars were defined by~\cite{Ribeiro1996} for the SPO approach and by~\cite{Corradini1996} for the DPO approach. They can be considered as a format for representing the concurrent semantics of a graph grammar that it is still a graph grammar.
