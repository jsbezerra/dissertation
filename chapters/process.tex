...
We are interested in a way of representing several (equivalent) possible derivations in a compact notation for later generation of tests.

For each system modelled as a graph grammar, there are many possible ways of 
