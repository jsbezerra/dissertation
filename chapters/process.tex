...
\begin{definition}[Doubly-Typed Graph Rule] Given a double-type graph $TG^T$, doubly-typed rule with respect to $TG^T$ is a span \doublyTypedRule{} in \doublyTypedGraphCategory{}. 
\end{definition}
