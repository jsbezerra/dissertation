...
are not \emph{stable under switch}, \newadd{which means that conflicts or dependencies that do not occur in a given sequence of transformations may arise if one or more pairs of transformations are switched.} An example is shown in Figure~\ref{ex:process:instability}.
