...
\begin{figure}[!ht]
  \centering
  \fbox{\includegraphics[scale=0.6]{images/process/incremental-nacs}}
...
\important{Define $pre_a$ and $post_a$ conditions here. Also define preservation}
