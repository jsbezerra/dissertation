...
\newcommand{\graphrule}{\mbox{$p = (L \xleftarrow{l} K \xrightarrow{r} R)$}}
\newcommand{\inversegraphrule}{\mbox{$p^{-1} = (R \xleftarrow{r} K \xrightarrow{l} L)$}}
...
\newcommand{\doublyTypedRule}{\mbox{$p = (L^{TG^T} \xleftarrow{l} K^{TG^T} \xrightarrow{r} R^{TG^T})$}}
\newcommand{\cat}{\mathbf}
\newcommand{\typedGraphCategory}{\mbox{$\cat{TGraph_T}$}}
\newcommand{\doublyTypedGraphCategory}{\mbox{$\cat{DTGraph_{TG^T}}$}}
