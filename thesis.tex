...
\newcommand{\graphrule}{$p = (L \xleftarrow{l} K \xrightarrow{r} R)$ }
\newcommand{\inversegraphrule}{$p^{-1} = (R \xleftarrow{r} K \xrightarrow{l} L)$ }
\newcommand{\lefthand}{$l : K \rightarrow L$ }
\newcommand{\righthand}{$r : K \rightarrow R$ }
